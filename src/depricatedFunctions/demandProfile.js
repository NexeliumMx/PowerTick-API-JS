 ...
 * Brief: HTTP GET endpoint to fetch power demand profile data for a specific powermeter in the production schema.
 * Date: 2025-02-24
 *
 * Description:
 * This function serves as an HTTP GET endpoint to fetch power demand profile data for a specific powermeter in the production schema.
 ...
 *
 * 3. Schema Setting: The function sets the search path to the desired schema (`production`).
 *
 ...
 * Local:
 *    curl -i -X GET "http://localhost:7071/api/demandProfile?user_id=4c7c56fe-99fc-4611-b57a-0d5683f9bc95&serial_number=DEMO000001&time_interval=day"
 * Production:
...
app.http('demandProfile', {
    ...
    handler: async (request, context) => {
        ...
        try {
            ...
            await client.query('SET search_path TO production');
