 ...
 * Local:
 *    curl -i -X GET "http://localhost:7071/api/demoConsumptionHistory?time_interval=day"
 *    curl -i -X GET "http://localhost:7071/api/demoConsumptionHistory?time_interval=hour"
 * Production:
 *    curl -i -X GET "https://power-tick-api-js.nexelium.mx/api/demoConsumptionHistory?time_interval=day"
 *    curl -i -X GET "https://power-tick-api-js.nexelium.mx/api/demoConsumptionHistory?time_interval=hour"
 *
 * Expected Response:
