/**
 * File: thdVoltageLLHistory.js
 * Author(s): Arturo Vargas
 * Endpoint: GET /api/thdVoltageLLHistory
 * Brief: Fetch THD voltage (LL, L1-L2, L2-L3, L3-L1) measurements for a powermeter, validating user access and UTC range.
 * Date: 2025-06-23
 * 
...
app.http('thdVoltageLLHistory', {
    ...
    handler: async (request, context) => {
        ...
        // Query: fetch THD voltage LL, L1-L2, L2-L3, L3-L1 using TimescaleDB optimizations
        const query = `
