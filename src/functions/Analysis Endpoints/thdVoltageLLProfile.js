/**
 * File: thdVoltageLLProfile.js
 * Author(s): Arturo Vargas
 * Endpoint: /api/thdVoltageLLProfile
 * Brief: Returns grouped THD voltage LL profile (hourly, daily, or monthly) for a powermeter, validating user access and UTC range.
 * Date: 2025-06-23
 * 
        ...
        if (time_interval === 'hour') {
            selectQuery = `
                SELECT
                    ...
                    max(m.thd_voltage_ll) AS thd_voltage_ll_max,
                    avg(m.thd_voltage_ll) AS thd_voltage_ll_avg,
                    max(m.thd_voltage_l1_l2) AS thd_voltage_l1_l2_max,
                    avg(m.thd_voltage_l1_l2) AS thd_voltage_l1_l2_avg,
                    max(m.thd_voltage_l2_l3) AS thd_voltage_l2_l3_max,
                    avg(m.thd_voltage_l2_l3) AS thd_voltage_l2_l3_avg,
                    max(m.thd_voltage_l3_l1) AS thd_voltage_l3_l1_max,
                    avg(m.thd_voltage_l3_l1) AS thd_voltage_l3_l1_avg
            ...
            selectQuery = `
                ...
                SELECT
                    ...
                    thd_voltage_ll_max,
                    thd_voltage_ll_avg,
                    thd_voltage_l1_l2_max,
                    thd_voltage_l1_l2_avg,
                    thd_voltage_l2_l3_max,
                    thd_voltage_l2_l3_avg,
                    thd_voltage_l3_l1_max,
                    thd_voltage_l3_l1_avg
                FROM monthly_data
