 ...
 * Local:
 *    curl -i -X GET "http://localhost:7071/api/fetchVoltagesLLMeasurements?user_id=4c7c56fe-99fc-4611-b57a-0d5683f9bc95&serial_number=DEMO000001"
 * Production:
 *    curl -i -X GET "https://power-tick-api-js.nexelium.mx/api/fetchVoltagesLLMeasurements?user_id=4c7c56fe-99fc-4611-b57a-0d5683f9bc95&serial_number=DEMO000001"
 *
 * --------------------------------------------------------------------------- 
*/
...
app.http('fetchVoltagesLLMeasurements', {
    methods: ['GET'],
    authLevel: 'anonymous',
